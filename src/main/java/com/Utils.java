...
//    public static String apiNearbySearch = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyA8G9ykgRsH0j4qydHmljXj2j9GJ-NMfWQ&radius=2000&location=";
    ...
    public static String apiKey = "AIzaSyA4iNKHqccgkphh0YtEEVF9Svz2zL0P3WI";
    public static String apiPlaceTextSearchUrl = "https://maps.googleapis.com/maps/api/place/textsearch/json?key=AIzaSyA4iNKHqccgkphh0YtEEVF9Svz2zL0P3WI&";
    public static String apiPlaceDetailSearchUrl = "https://maps.googleapis.com/maps/api/place/details/json?key=AIzaSyA4iNKHqccgkphh0YtEEVF9Svz2zL0P3WI&";
    public static String apiPhotoUrl = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&key=AIzaSyA4iNKHqccgkphh0YtEEVF9Svz2zL0P3WI&photoreference=";
    public static String apiNearbySearch = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyA4iNKHqccgkphh0YtEEVF9Svz2zL0P3WI&radius=2000&location=";
